# -*- coding: utf-8 -*-
"""
Random Forest - Détection Parkinson + interface Tkinter
"""
...
print("✔️ Colonnes utilisées dans le modèle (features) :")
print(feature_names)
...
# GUI
root = tk.Tk()
root.title("Détection de la maladie de Parkinson - Random Forest")
